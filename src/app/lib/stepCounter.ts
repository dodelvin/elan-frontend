...
const STEP_THRESHOLD = 30; // acceleration magnitude threshold to count a step (tuned experimentally)
const MIN_STEP_INTERVAL_MS = 1000; // minimum time between steps to prevent double-counting (tuned experimentally)
