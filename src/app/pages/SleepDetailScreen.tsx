...
import { ChevronLeft, Moon, Plus, Minus } from 'lucide-react';
...
export function SleepDetailScreen() {
  ...
  // Load today's sleep + weekly chart in parallel.
  useEffect(() => {
  ...
  // Week data — backend gives last 7 days; map to chart shape with date labels.
        ...
        <Card className="mb-6 p-6">
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={weekData} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
              ...
              <YAxis axisLine={false} tickLine={false} tick={{ fill: 'var(--color-mid-dark)', fontSize: 12 }} domain={[0, goalHours]} />
